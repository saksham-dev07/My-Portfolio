...
export const technologies = [
    // Core Languages
    { name: "Python", icon: PythonIcon, category: "Languages", desc: "Primary systems & AI language" },
    { name: "Java", icon: JavaIcon, category: "Languages", desc: "OOP, data structures & algorithms" },
    { name: "C++", icon: CppIcon, category: "Languages", desc: "High-performance systems & problem solving" },
    { name: "TypeScript", icon: TsIcon, category: "Languages", desc: "Typed scalable modern JavaScript" },
    { name: "JavaScript", icon: JsIcon, category: "Languages", desc: "Core interactive web development" },
    { name: "C", icon: CIcon, category: "Languages", desc: "Low-level memory & OS fundamentals" },

    // Web & Full-Stack
    { name: "React.js", icon: ReactIcon, category: "Frontend", desc: "Reactive component architecture" },
    { name: "Next.js", icon: NextIcon, category: "Frontend", desc: "Server-side rendering & App Router" },
    { name: "FastAPI", icon: FastapiIcon, category: "Backend", desc: "High-throughput async Python REST APIs" },
    { name: "Flask", icon: FlaskIcon, category: "Backend", desc: "Lightweight Python microservices" },
    { name: "Node.js", icon: NodeIcon, category: "Backend", desc: "Asynchronous event-driven runtime" },
    { name: "Express.js", icon: ExpressIcon, category: "Backend", desc: "RESTful server routing & middleware" },
    { name: "Tailwind CSS", icon: TailwindIcon, category: "Frontend", desc: "Modern utility-first responsive UI" },
    { name: "Redux Toolkit", icon: ReduxIcon, category: "Frontend", desc: "Predictable centralized state management" },
    { name: "Three.js", icon: ThreeIcon, category: "Frontend", desc: "Interactive WebGL 3D graphics" },
    { name: "HTML5", icon: HtmlIcon, category: "Frontend", desc: "Semantic structure & accessibility" },
    { name: "CSS3", icon: CssIcon, category: "Frontend", desc: "Fluid layouts & modern animations" },

    // AI & Machine Learning
    { name: "PyTorch", icon: PytorchIcon, category: "AI & ML", desc: "Deep learning & neural networks" },
    { name: "TensorFlow", icon: TensorflowIcon, category: "AI & ML", desc: "End-to-end ML model pipelines" },
    { name: "OpenCV", icon: OpencvIcon, category: "AI & ML", desc: "Computer vision & image analysis" },
    { name: "scikit-learn", icon: ScikitlearnIcon, category: "AI & ML", desc: "Predictive modeling & statistical ML" },

    // Databases & Cloud
    { name: "PostgreSQL", icon: PostgresIcon, category: "Cloud & DB", desc: "Relational database & SQL queries" },
    { name: "MongoDB", icon: MongoIcon, category: "Cloud & DB", desc: "NoSQL document store & collections" },
    { name: "MySQL", icon: MysqlIcon, category: "Cloud & DB", desc: "Relational database management" },
    { name: "Firebase", icon: FirebaseIcon, category: "Cloud & DB", desc: "Realtime database & cloud auth" },
    { name: "Appwrite", icon: AppwriteIcon, category: "Cloud & DB", desc: "Secure backend-as-a-service" },
    { name: "Google Cloud", icon: GcpIcon, category: "Cloud & DB", desc: "GCP infrastructure & cloud compute" },
    { name: "AWS", icon: AwsIcon, category: "Cloud & DB", desc: "Certified AI Practitioner & cloud architecture" },

    // DevOps & Tools
    { name: "Docker", icon: DockerIcon, category: "DevOps & Tools", desc: "Containerization & deployment" },
    { name: "Git", icon: GitIcon, category: "DevOps & Tools", desc: "Version control & collaboration" },
    { name: "Linux", icon: LinuxIcon, category: "DevOps & Tools", desc: "POSIX terminal & shell automation" },
    { name: "Postman", icon: PostmanIcon, category: "DevOps & Tools", desc: "API testing, mocks & documentation" },
    { name: "Vercel", icon: VercelIcon, category: "DevOps & Tools", desc: "Edge deployment & CI/CD workflows" },
    { name: "Jupyter", icon: JupyterIcon, category: "DevOps & Tools", desc: "Data exploration & ML prototyping" },
    { name: "Figma", icon: FigmaIcon, category: "DevOps & Tools", desc: "UI/UX wireframing & prototyping" },
];
...
export const certifications = [
    {
        ...
        credentialUrl: "https://cp.certmetrics.com/amazon/en/public/verify/credential/a9c8149546a744f1abfb63c0140809fc",
        description:
        ...
        skills: ["Generative AI", "Machine Learning", "Amazon Bedrock", "Prompt Engineering", "Responsible AI"],
    ...
    },
    {
        ...
        credentialUrl: "https://cp.certmetrics.com/amazon/en/public/verify/credential/06aad1dcc8e147cdb48972cb44a6c810",
        description:
        ...
        skills: ["Cloud Computing", "AWS Core Services", "Cloud Security", "Cloud Architecture", "Billing & Pricing"],
    ...
    },
    {
        ...
        credentialUrl: "https://courses.vit.skillsnetwork.site/certificates/60c690f32b0840d1846b829372463e44",
        description:
        ...
        skills: ["Generative AI", "IBM Watsonx", "Prompt Engineering", "Foundation Models", "LLM Tuning"],
    ...
    },
    {
        ...
        skills: ["Edge Computing", "Applied AI", "Industrial IoT", "Embedded Systems", "Computer Vision"],
    ...
    },
    {
        ...
        date: "2025-05-15",
        credentialUrl: "https://www.skills.google/public_profiles/eac4a7ac-4652-4ab3-bded-ae5785b67892",
        description:
            "Hands-on expertise in cloud architecture, GCP services, infrastructure deployment, and cloud-hosted ML services.",
        skills: ["Google Cloud", "Cloud Architecture", "BigQuery", "Compute Engine", "Cloud Security"],
        imageSrc: google,
        profilePic: google,
    },
    {
        ...
        skills: ["Computer Networking", "TCP/IP Protocol", "Network Troubleshooting", "DNS & DHCP", "Routing"],
